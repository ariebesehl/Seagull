...
void SGUI_Init(void) {
    if (gMain != NULL) {
        gMain->font.window = ZTK_FontNew(NULL, (ZT_CHAR*)SG_FONT_WINDOW, ZTK_DEFAULT_WINDOW_TEXT_SIZE, ZTM_FONT_STYLE_NORMAL, ZTK_DEFAULT_WINDOW_TEXT_COLOR);
        gMain->font.title = ZTK_FontNew(NULL, (ZT_CHAR*)SG_FONT_TITLE, ZTK_DEFAULT_WINDOW_TEXT_SIZE, ZTM_FONT_STYLE_NORMAL | ZTM_FONT_STYLE_ALIGN_CENTER, ZTK_DEFAULT_WINDOW_TEXT_COLOR);
        gMain->font.desc = ZTK_FontNew(NULL, (ZT_CHAR*)SG_FONT_TITLE, ZTK_DEFAULT_WINDOW_TEXT_SIZE, ZTM_FONT_STYLE_NORMAL | ZTM_FONT_STYLE_ALIGN_CENTER, ZTK_DEFAULT_WINDOW_TEXT_COLOR);
